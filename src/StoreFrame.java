...
public class StoreFrame extends JFrame implements ActionListener, MouseListener
{
    ...
    public Vector<Object> columnNames;
    ...
    public JMenu logInMenu; //one dropdown part of the menu bar declared here so it can be referenced
    public JMenu adminMenu;

    public static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
    public static final String DATABASE_URL = "jdbc:mysql://localhost:3306/movies&books"/*"jdbc:mysql://falcon-cs.fairmontstate.edu/DB00";SWAP THESE FOR SCHOOL EDITING.*/;
    public static final String USERNAME = "root";
    public static final String PASSWORD = "admin";//"password"  //Adust this according to local host login or server login

//=====================================================
    @SuppressWarnings(
            {
                "LeakingThisInConstructor", "OverridableMethodCallInConstructor"
            })
    public StoreFrame()
    {
